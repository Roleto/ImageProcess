...
video_file = "../../../Kéfeldolgozás/Datasets/Videos/hd_daschcam_cropped.mp4"
...
def example3():
    ...
    classifier_data = trainSVM(feature_data=feature_data, loss="squared_hinge",
                               ...
                               output_filename="classifier_data.pkl")
...
def example4():
    ...
    detector.loadClassifier(filepath="myfile.pkl")
    cap = cv2.VideoCapture(video_file)
...
def example5():
    ...
    detector = Detector(init_size=(16, 16), x_overlap=0.7, y_step=0.01,
                        x_range=(0.235, 0.3825), y_range=(.3125, .5625), scale=1.3)
    detector.loadClassifier(classifier_data=classifier_data)
